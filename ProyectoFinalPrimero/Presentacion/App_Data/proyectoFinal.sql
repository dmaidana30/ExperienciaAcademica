...
(
	NAME=ProyectoFinal,
	FILENAME='E:\Workspace\BD2021\ProyectoFinal.mdf'
)
...
/*declare @resp int
exec @resp = AgregarEmpresa 1,'Emp7','541531','hgjfghjfgjgfj'
print @resp*/
GO
...
begin
		if @EstadoActual NOT IN ('endeposito','encamino')
			return -1
		if exists (SELECT* FROM  SolicitudEntrega WHERE NumeroInt = @NumeroInt )
			return -2
